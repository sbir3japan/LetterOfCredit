...
var ApplyForLocComponent = (function () {
    ...
    ApplyForLocComponent.prototype.autoComplete = function () {
        ...
        this.loc.portDischargeCountry = 'GB';
        ...
        this.loc.placePresentationCountry = 'GB';
